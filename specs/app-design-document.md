...
This document defines the **complete vision, scope, constraints, and requirements** for **v1** of a client-side web application for the tabletop RPG _Microscope_.
...
A **local-first, asynchronous worldbuilding notebook** for the game _Microscope_.
